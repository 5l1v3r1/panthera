...
print "[ + ] Design Scheme: 	DNS server cache information leakage\n";
...
$sys = system("nmap -sU -p 53 --script dns-cache-snoop.nse --script-args 'dns-cache-snoop.mode=nonrecursive' '$url' ") ;
print "\n";
exit;
